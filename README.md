...
______
## Updates for v1.0.1 (updated 10/23/19):  
#### Summary:  
...
## Running VIBRANT in CyVerse DE
VIBRANT is currently integrated in CyVerse’s Discovery Environment (DE) and is free to use by researchers. The complete tutorial is available at this CyVerse [wiki](https://wiki.cyverse.org/wiki/display/DEapps/VIBRANT-1.0.1). [CyVerse's DE](https://cyverse.org/discovery-environment) is a free and easy to use GUI that simplifies many aspects of running bioinformatics analyses. Clicking the button below will take you to the VIBRANT-1.0.1 app with all defaults already filled in.

<a href="https://de.cyverse.org/de/?type=quick-launch&quick-launch-id=76e98e23-f55c-4ef3-878a-a8a1625f4ec4&app-id=c2864d3c-fd03-11e9-9cf4-008cfa5ae621" target="_blank"><img src="https://de.cyverse.org/Powered-By-CyVerse-blue.svg"></a>
